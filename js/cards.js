...
// 卡面文字（desc）保持一句话简洁；升星数值变化放"下一星"行（前缀由渲染层统一添加）。
...
(function () {
  ...
  { id:'ZJ-02', name:'破风剑势', school:'piaobo', type:'growth', stars:3,
    ...
    next:{1:'距离/速度/宽度继续提升', 2:'距离/速度/宽度进一步提升'},
  ...
  /* ================= B. 战士 · 重骑士 ================= */
  { id:'ZQ-01', name:'铁壁披身', school:'zhongqi', type:'core', stars:1,
  ...
  { id:'ZQ-02', name:'重甲锻身', school:'zhongqi', type:'growth', stars:3,
    ...
    next:{1:'生命+40，盾牌+25', 2:'生命+55，盾牌+35'},
  ...
  { id:'ZQ-05', name:'血战不退', school:'zhongqi', type:'growth', stars:3,
    ...
    next:{1:'触发区间50%，近战+30%', 2:'触发区间60%，近战+40%'},
  ...
  /* ================= E. 法师 · 坠星法师 ================= */
  { id:'FX-01', name:'唤星之术', school:'zhuixing', type:'core', stars:1,
  ...
  /* ================= F. 法师 · 巫师 ================= */
  { id:'FW-01', name:'毒咒入骨', school:'wushi', type:'core', stars:1,
    desc:'法术命中叠加中毒，持续扣血',
  ...
  { id:'FW-04', name:'寒滞咒', school:'wushi', type:'growth', stars:3,
    desc:'附加减速，反复施法可冻结目标',
    next:{1:'减速28%/冰冻1.2秒', 2:'减速36%/冰冻1.5秒'},
